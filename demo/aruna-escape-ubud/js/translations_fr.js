window.translations_fr = {
  hero: {
    ...
    subtitle: "Villa jungle unique près du centre d'Ubud",
  ...
  amenities: {
    ...
    view: "Vue jungle",
    checkin: "Arrivée autonome (coffre-fort)",
    cleaning: "Nettoyage quotidien disponible",
    privacy: "Intimité totale, pas de distractions",
    bathtub: "Baignoire jungle",
    title: "Équipements",
  },
  gallery: {
    title: "Découvrez Aruna Escape",
    subtitle: "Découvrez la beauté et le confort de notre retraite jungle",
  },
  location: {
